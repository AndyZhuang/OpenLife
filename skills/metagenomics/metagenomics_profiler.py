#!/usr/bin/env python3
"""
OpenLife Metagenomics Profiler
...
SAFETY_DISCLAIMER = (
    "OpenLife is a research and educational tool. It is not a medical device "
...
**Date**: {now}
**Tool**: OpenLife Metagenomics Profiler v0.1.0
...
# Reproducibility script — OpenLife Metagenomics Profiler
...
"""
    ...
    # environment.yml
    env_yml = """name: openlife-metagenomics
channels:
  - bioconda
  - conda-forge
  - defaults
...
def run_demo(output_dir: Path) -> None:
    ...
    print("Metagenomics Profiler -- OpenLife")
    print("=" * 40)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "OpenLife Metagenomics Profiler: Kraken2/Bracken taxonomy + "
