...
def generate_report(input_path, fmt, total_snps, pgx_snps, profiles, drug_results):
    ...
    lines = []
    lines.append("# OpenLife PharmGx Report")
    lines.append("")
    ...
    lines.append("")
    lines.append("- **Tool**: OpenLife PharmGx Reporter v0.1.0")
    ...
    lines.append("")
    lines.append("- Corpas, M. (2026). OpenLife. https://github.com/OpenLife/OpenLife")
...
def main():
    parser = argparse.ArgumentParser(
        description="OpenLife PharmGx Reporter: pharmacogenomic report from DTC genetic data")
    ...
    print(f"OpenLife PharmGx Reporter v0.1.0")
    print(f"================================")
    print()
